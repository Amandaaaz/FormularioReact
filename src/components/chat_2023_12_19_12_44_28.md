...
import '../index.css';
import MensagemInicial from '.src/components/Formulario.js'; // Substitua pelo caminho real
    ...
    <FormContainer style={fade}>
      <PerguntaContainer style={slide}>
        {concluido ? (
          ...
          <MensagemInicial>
            Bem-vindo ao formulário SoftexLabs! Serão 12 perguntas rápidas, vamos lá?
          </MensagemInicial>
        ) : (
...
12. **You**: olá
13. **You**: olá
14. **You**: corrija o erro
15. **You**: corrija o erro
16. **You**: corrija o erro
17. **You**: corrija o erro
18. **You**: corrija o erro
19. **You**: corrija o erro